...
#+DESCRIPTION: Demonstrates how ThreadPoolExecutor can cause deadlocks when parent tasks wait for child tasks that require the same executor. Shows deadlock scenario and potential workarounds.
